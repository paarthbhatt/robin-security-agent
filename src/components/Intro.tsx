...
export function Intro({ provider, model }: IntroProps) {
  ...
  const welcomeText = 'Welcome to ROBIN';
...
╚═╝  ╚═╝ ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝`}
      ...
      <Box marginY={1} flexDirection="column">
        <Text>Reconnaissance & Operations Bot for Intelligence Networks.</Text>
        <Text color={colors.muted}>Tactical Sidekick to BATMAN.</Text>
